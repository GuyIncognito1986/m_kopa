...
public class SMSStateMachineTests
{
    ...
    public async Task HappyPath()
    {
        ...
        var cuid = new Visus.Cuid.Cuid2();
        A.CallTo(() => fakedQueueClient.Deserialize(Array.Empty<byte>())).Returns(new SendSmsCommand(cuid, GetPhoneNumber(), _textMessage));
        ...
        A.CallTo(() => fakedSmsStateServiceClient.SetStateAsync(cuid, Lib.StateMachines.SMSStateMachine.States.MessageSendSuccessful)).Returns(Task.FromResult(0));
